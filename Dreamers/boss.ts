namespace Dreamers {
    ...
    export class Boss extends Enemy {
        ...
        private material: ƒ.Material = new ƒ.Material("player", ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("black")));

        //The node's child nodes
        private body: ƒ.Node;
        private horizontalGun: ƒ.Node;
        private verticalGun: ƒ.Node;
        private diagonalGun1: ƒ.Node;
        private diagonalGun2: ƒ.Node;

        //The time between shots
        private rateOfFire: number = 45;
        ...
        //Constructor
        constructor(_spawnpoint: number) {
            ...
            this.horizontalGun = new ƒAid.Node("gun", ƒ.Matrix4x4.IDENTITY(), new ƒ.Material("boss", ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("black"))), Enemy.mesh);
            this.verticalGun = new ƒAid.Node("gun", ƒ.Matrix4x4.IDENTITY(), new ƒ.Material("boss", ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("black"))), Enemy.mesh);
            this.diagonalGun1 = new ƒAid.Node("gun", ƒ.Matrix4x4.IDENTITY(), new ƒ.Material("boss", ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("black"))), Enemy.mesh);
            this.diagonalGun2 = new ƒAid.Node("gun", ƒ.Matrix4x4.IDENTITY(), new ƒ.Material("boss", ƒ.ShaderFlat, new ƒ.CoatColored(ƒ.Color.CSS("black"))), Enemy.mesh);
            ...
            let horizontalMatrix: ƒ.Matrix4x4 = this.horizontalGun.getComponent(ƒ.ComponentMesh).pivot;
            horizontalMatrix.scale(new ƒ.Vector3(0.1, 0.1, 0.9));

            let verticalMatrix: ƒ.Matrix4x4 = this.verticalGun.getComponent(ƒ.ComponentMesh).pivot;
            verticalMatrix.scale(new ƒ.Vector3(0.9, 0.1, 0.1));
      
            let diagonalMatrix1: ƒ.Matrix4x4 = this.diagonalGun1.getComponent(ƒ.ComponentMesh).pivot;
            diagonalMatrix1.scale(new ƒ.Vector3(0.9, 0.1, 0.1));
            diagonalMatrix1.rotate(new ƒ.Vector3(0, 135, 0), true);
       
            let diagonalMatrix2: ƒ.Matrix4x4 = this.diagonalGun2.getComponent(ƒ.ComponentMesh).pivot;
        ...
        public update(player: Player): void {
            ...
            if (this._spawnpoint == 5) {
                ...
                if (this.reload == 0) {
                    ...
                    let leftBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(0, 0, this.mtxLocal.translation.z - 1));
                    let rightBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(0, 0, this.mtxLocal.translation.z + 1));
                    let topBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x + 1, 0, 0));
                    let bottomBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x - 1, 0, 0));

                    let topLeftBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x + 1, 0, this.mtxLocal.translation.z - 1));
                    let topRightBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x + 1, 0, this.mtxLocal.translation.z + 1));

                    let bottomLeftBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x - 1, 0, this.mtxLocal.translation.z - 1));
                    let bottomRightBullet: Bullet = new Bullet(this.mtxLocal.translation, new ƒ.Vector3(this.mtxLocal.translation.x - 1, 0, this.mtxLocal.translation.z + 1));
                ...
                for (let i: number = 0; i < this.enemyBullets.length; i++) {
                    ...
                    if (this.enemyBullets[i].mtxLocal.translation.x <= (player.mtxLocal.translation.x + player.getRadius()) && this.enemyBullets[i].mtxLocal.translation.x >= (player.mtxLocal.translation.x - player.getRadius())
                        ...
                        viewport.getGraph().removeChild(this.enemyBullets[i]);
